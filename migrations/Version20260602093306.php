 ...
 */
final class Version20260602093306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE campagne (id VARCHAR(50) NOT NULL, titre VARCHAR(255) DEFAULT NULL, contenu LONGTEXT DEFAULT NULL, objectif BIGINT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, cree_a DATETIME DEFAULT NULL, mise_a_jour DATETIME DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
